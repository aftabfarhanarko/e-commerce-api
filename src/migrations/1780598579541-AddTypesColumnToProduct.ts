...
export class AddTypesColumnToProduct1780598579541 implements MigrationInterface {
    name = 'AddTypesColumnToProduct1780598579541'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "orders" DROP COLUMN "clientInfo"`);
        await queryRunner.query(`ALTER TABLE "orders" DROP COLUMN "categoryInfo"`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ALTER COLUMN "paidAmount" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "orders" DROP COLUMN "status"`);
        await queryRunner.query(`DROP TYPE "public"."orders_status_enum"`);
        await queryRunner.query(`ALTER TABLE "orders" ADD "status" character varying NOT NULL DEFAULT 'pending'`);
        await queryRunner.query(`ALTER TABLE "orders" DROP CONSTRAINT "UQ_8335aaed3710c942dd5deefaa95"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "orders" DROP COLUMN "orderInfo"`);
        await queryRunner.query(`ALTER TABLE "orders" ADD "orderInfo" character varying`);
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "UQ_8335aaed3710c942dd5deefaa95" UNIQUE ("orderInfo")`);
        await queryRunner.query(`ALTER TABLE "orders" DROP COLUMN "status"`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ALTER COLUMN "paidAmount" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD "categoryInfo" integer`);
        await queryRunner.query(`ALTER TABLE "orders" ADD "clientInfo" integer`);
        await queryRunner.query(`ALTER TABLE "orders" ADD "orderId" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD "amount" numeric(10,2)`);
        await queryRunner.query(`ALTER TABLE "orders" ADD "service" character varying`);
